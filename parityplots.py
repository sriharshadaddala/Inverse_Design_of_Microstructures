...
# 2. LOAD YOUR DATA
# ==========================================
target_file = '/Users/harsha/Desktop/PhD_project/Updated_Model/TestRVE.csv'
predicted_file = '/Users/harsha/Desktop/PhD_project/Updated_Model/Combined_Master_Results_400.csv'
...
# Placed in the bottom-right corner
    ax.text(0.95, 0.05, f'Spearman = {spearman_corr:.3f}\nMAE = {mae:.3g}\nRMSE = {rmse:.3g}', 

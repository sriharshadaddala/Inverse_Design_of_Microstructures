...
import warnings
# 1. Set your path
csv_path = "/Users/harsha/Desktop/PhD_project/Updated_Model/X_unique.csv"
csv_path_condition =  "/Users/harsha/Desktop/PhD_project/Updated_Model/Trainingdata.csv"
save_path = '/Users/harsha/Desktop/PhD_project/Updated_Model/Inputdata_Normalised'
# 2. Load the data 
# Using pandas is safer for CSVs to handle headers automatically
...
def fit_optimal_1d_gmm(column_data, max_k=8):
    ...
    for k in range(1, max_k + 1):
        # We wrap the fitting process in a warning filter
        with warnings.catch_warnings():
            warnings.simplefilter("ignore") # This mutes the K-Means math panic
            
            gmm = GaussianMixture(n_components=k, random_state=42, reg_covar=1e-5)
            gmm.fit(X)
...
verification_df.to_csv("/Users/harsha/Desktop/PhD_project/Updated_Model/RAW_Alignment_Verification.csv", index=False)
...
# THE ULTIMATE PROOF: INVERSE NORMALIZATION CHECK
# =====================================================================
...
raw_conditions_0 = df_c[condition_cols].iloc[1258].values
